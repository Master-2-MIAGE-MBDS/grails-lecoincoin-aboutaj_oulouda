...
<div id="show-annonce" class="content scaffold-show" role="main">
    ...
    <ol class="property-list annonce">
        ...
        <li class="fieldcontain">
            <span id="active-label" class="property-label">Active</span>

            <div class="property-value" aria-labelledby="active-label">${annonce.active}</div>
        </li>
        ...
        <li class="fieldcontain">
            ...
            <div class="property-value" aria-labelledby="author-label"><a
                    href="/user/show/2">${annonce.author.username}</a></div>
        </li>
